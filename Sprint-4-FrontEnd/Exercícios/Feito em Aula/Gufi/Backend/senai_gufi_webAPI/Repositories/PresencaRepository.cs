...
namespace senai_gufi_webAPI.Repositories
{
    ...
    public class PresencaRepository : IPresencaRepository
    {
        ...
        /// </summary>
        GufiContext ctx = new();
        public void AprovarVRecusar(int idPresenca, string status)
        {
        ...
        public void Inscrever(Presenca insricao)
        {
            ctx.Presencas.Add(insricao);
            ctx.SaveChanges();
        }
        ...
        public List<Presenca> ListarMinhas(int idUsuario)
        {
            return ctx.Presencas
                //.Include(p => p.IdUsuarioNavigation).ThenInclude(e => e.idTipoEventoNavigation)
